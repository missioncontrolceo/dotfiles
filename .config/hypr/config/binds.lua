...
--Eddie Native App Binds--

hl.bind(mainMod .. " + S", hl.dsp.exec_cmd(launchPrefix .. "slack"))
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(launchPrefix .. "claude-desktop"))
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd(launchPrefix .. "todoist"))
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd(launchPrefix .. "notion-app"))

--Eddie Chrome Apps--
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd("google-chrome-stable --profile-directory=Default --app-id=lnachpgegbbmnnlgpokibfjlmppeciah"))
hl.bind(mainMod .. " + Y", hl.dsp.exec_cmd("google-chrome-stable --profile-directory=Default --app-id=agimnkijcaahngcdmfeangaknmldooml"))
...
-- Focus on monitors (moved off the number keys)
hl.bind(mainMod .. " + F1", hl.dsp.focus({ monitor = MONITOR1 }))
hl.bind(mainMod .. " + F2", hl.dsp.focus({ monitor = MONITOR2 }))
